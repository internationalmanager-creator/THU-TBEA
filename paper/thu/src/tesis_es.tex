...
\author{Erick Duque \\ \texttt{0009-0004-1245-5464} \\ \textit{Teoria Helicoidal Universal THU-TBEA 5.3}}
\date{Version 5.3 · 2026-09-20 \\ \small DOI pendiente (manuscrito en preparacion) \\ \small CC-BY-4.0}

\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small Teoria Helicoidal Universal THU-TBEA 5.3}
...
Leyenda epistemica: [D] derivado, [P] postulado, [F] frontera (abierto), [A] analogia.
...
\subsection*{Capitulo 1. Introduccion e historia critica}
\subsection*{Capitulo 2. Marco normativo, reproducibilidad y arquitectura computacional}
\subsection*{Capitulo 3. Geometria U4: torsion axial como solucion exacta de Palatini}
...
\subsection*{Capitulo 4. Operadores no locales: analisis funcional, unitariedad y sector trans-escalar}
...
\subsection*{Capitulo 5. Analisis de Dirac-Bergmann: un grado de libertad y causalidad proyectada}
...
\subsection*{Capitulo 6. Grupo de renormalizacion a 1-loop: punto fijo aureo}
...
\subsection*{Capitulo 7. Cancelacion del vacio escalar modulado: mecanismo parcial}
...
\subsection*{Capitulo 8. Cosmologia helicoidal cerrada: Friedmann modificada}
...
\subsection*{Capitulo 9. Mecanismo chameleon cuantitativo}
...
\subsection*{Capitulo 10. Exodo quiral y birefringencia cosmica}
...
\subsection*{Capitulo 11. Tomografia beta(z) derivada de las EOM}
\subsection*{Capitulo 12. Espectro hadronico: escala trans-escalar}
...
\subsection*{Capitulo 13. Revision empirica sistematica I (PRISMA)}
\subsection*{Capitulo 14. Energia oscura dinamica y DESI DR2}
\subsection*{Capitulo 15. Paridad en el sector gravitacional}
\subsection*{Capitulo 16. Spin y vorticidad: RHIC, STAR}
\subsection*{Capitulo 17. Sintesis falsable: predicciones P1-P11}
\subsection*{Capitulo 18. Ajuste conjunto sobre datos publicos}
\subsection*{Capitulo 19. Pipeline reproducible y pruebas unitarias}
\subsection*{Capitulo 20. Problemas abiertos y trabajo futuro}
\subsection*{Capitulo 21. Conclusiones y evaluacion lakatosiana final}
\newpage

\section*{Appendices}

\subsection*{Apendice A. Glosario de simbolos y convenciones}
\subsection*{Apendice B. Demostraciones matematicas completas}
\subsection*{Apendice C. Protocolo PRISMA: corpus, flujo y extraccion}
\subsection*{Apendice D. Pipeline reproducible: codigo, hashes y pruebas}
\subsection*{Apendice E. Atlas de figuras y tabla maestra}
\subsection*{Apendice F. Bitacora lakatosiana, cierre y trabajo futuro}
\subsection*{Apendice G. Morfologias aureas en sistemas naturales (V1-V7)}
\subsection*{Apendice H. Coherencia cuantica a temperatura ambiente: PS-TET y microtubulos}
\subsection*{Apendice I. Ecuaciones reconstruidas y matriz de Poisson completa}
\subsection*{Apendice J. Revision algebraica externa: parches aplicados}
\newpage
